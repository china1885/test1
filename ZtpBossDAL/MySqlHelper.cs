...
namespace ZtpBoss.DAL
{
    ...
    {
        //数据库连接字符串
        public static string Conn = "Database='db1';Data Source='43.226.146.183';User Id='outsider';Password='5201314';charset='utf8';pooling=true;SslMode = none;";
        //public static string Conn = "Database='db1';Data Source='" +
        //    Lyy.Settings.GetValue("DataSource") +
        //    "';User Id='outsider';Password='5201314';charset='utf8';pooling=true;SslMode = none;";
